...
//$up->set("path", ServiceManager::getConfig()['document_root'] . ServiceManager::getConfig()['img_upload']);
...
//
//$status = $up->upload("file");
//
//if ($status) {
//    return JsonRespose::success(array('filename' => $up->getFileName(), 'url' => ServiceManager::getConfig()['img_upload'] . '/' . $up->getFileName()));
//} else {
//    return JsonRespose::fail($up->getErrorMsg());
//}
...
class FileUpload
{
    ...
    private $maxsize = 2000000;           //限制文件上传大小（字节） 2000000≈2M
    ...
    private function checkFilePath()
    {
        ...
        if (!file_exists($this->path) || !is_writable($this->path)) {
            if (!FileFun::createDir($this->path)) {
