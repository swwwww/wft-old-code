...
//        //验证
//        if ($_SERVER['REQUEST_URI'] != '/seller/index/login' and  $_SERVER['REQUEST_URI'] != '/seller/index/forget' and $_SERVER['REQUEST_URI'] != '/seller/index/change' and $_SERVER['REQUEST_URI'] != '/seller/index/pay') { //排除登陆界面
//            if ($_COOKIE['user']) {
...
//                }
//            }
//            header('Location: /seller/index/login');
//            exit;
//        }
    }
